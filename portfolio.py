...
class portfolio():
    ...
    def add_position(self, symbol:str, purchase_date: Optional[str] ,asset_type:str, quantity:int = 0, purchase_price: float= 0.0) -> dict:
    ...
    def remove_position(self, symbol:str) -> Tuple[bool, str]:
        ...
        if symbol in self.positions:
            ...
            return(True, "Symbol{} was successfuly removed".format(symbol=symbol))
        else :
            return (False, "Symbol{} doesn't exist in the portfolio".format(symbol=symbol))
